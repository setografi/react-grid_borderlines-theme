...
function Services() {
  return (
    <section className="w-full grid grid-flow-row mx-auto">
      <div className="px-8 md:px-16 lg:px-32 border-y border-lightGray-700 border-dashed">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 border-x border-lightGray-700 border-dashed">
      ...
      <div className="h-24 grid grid-cols-[30%_1fr] px-8 md:px-16 lg:px-32 border-b border-lightGray-700 border-dashed">
