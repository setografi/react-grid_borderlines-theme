    ...
    <section className="w-full mx-auto">
      <div className="px-8 md:px-16 lg:px-32 border-t border-lightGray-700 border-dashed">
        <div className="border-x border-lightGray-700 border-dashed">
          <div className="group grid grid-cols-1 lg:grid-cols-2 p-5 md:p-10 border border-lightGray-700 rounded-lg hover:shadow-xl shadow-darkGray-700 duration-300 transition-all overflow-hidden">
